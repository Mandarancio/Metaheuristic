...
<\body>
  ...
  <\equation*>
    <around*|\<nobracket\>|f<around*|(|x<rsub|>|)>=<around*|(||\<nobracket\>>\<neg\>x<rsub|1>\<wedge\>x<rsub|2>\<wedge\>
    x<rsub|3>\<vee\> \<neg\><around*|(|x<rsub|2>\<vee\>x<rsub|3>|)>|)>\<wedge\>x<rsub|4>
  </equation*>
  ...
  8<math|<rsup|13>> (<math|\<sim\>0.5 .10<rsup|12>>) possible combinations of
  the symbol set.\ 
  ...
  The Genetic Programming (<strong|GP>) technique was first developed by
  <em|J.R. Koza et al.>, in the 90's, starting from the Genetic Algorithm
  (<strong|GA>). The logic behind the <strong|GP> is the same as in the
  <strong|GA>: through a process of selection, crossover and mutation,
  generation by generation, the research spac<strong|>e <math|S> will be
  efficiently explored and an optimal (or acceptable) solution found. The
  individuals in <strong|GP> are not just values or data but simple programs.

  In order to deal with the need of a reliable syntax capable to resist to
  crossover and mutation processes, the proposed solutions are two:
  ...
  simplify the implementation by fixing the program size.\ 

  A program written in post-fix syntax will, for example, look something like
  <verbatim|"2 NEG X SIN Y DIV MUL"> to represent
  <math|-2\<cdot\><frac|sin<around*|(|x|)>|y>>. The program will be built by
  taking symbols from 2 sets:
  ...
  <section|GP and Boolean Expressions>
  ...
  <\enumerate>
    ...
    <item>The number of errors encountered in the execution of the programs
    (<math|e<rsub|c><around*|(|s<rsub|i>|)>>), e.g. the program
    <verbatim|"AND AND NOT"> contains 3 errors and
    <math|e<rsub|c><around*|(|s<rsub|i>|)>=3>.
    ...
    X2 X3"> will leave 2 elements in the stack and
    <math|p<rsub|c><around*|(|s<rsub|i>|)>=2>.
  </enumerate>
  ...
  correct results but also the ones more syntactically correct. The range of
  ...
  to re-implement the code in C++ (maintaining the same structure,
  ...
  In Fig. 1, it's possible to see that the landscape doesn't follows a
  Gaussian distribution due to it's upper limit but it would fit probably
  better a Maxwell-<with|font-series||Boltzmann> distribution. In particular
  these 1000 events have average -670.5, STD 357.7, best value -5 and worst
  -1885.
  ...
  important, the trend of the average fitness is flat. The only small
  difference is on the fitness STD that decreases with increasing
  <math|p<rsub|c>> (from <math|\<sim\>0.7\<rightarrow\>\<sim\>0.45>). This
  trend, nevertheless, could be explained by statistical fluctuations.
  ...
  <\with|color|magenta>
    <with|color|black|The first notable results of this analysis are that my
    implementation of the<strong| GP> is capable to find solutions to the
    problem (of length 10, 11 and 12) shorter than the classical Karnaugh map
    (that gave me programs of length 13). This could be due to the fact that
    the XOR operator hides some complexity.>
  </with>

  <with|color|magenta|<with|color|black|Moreover,>> from the figures, it's
  possible to see that, even if the research space <math|S> increases with
  the program length <math|p<rsub|l>> (the research space size is
  <math|8<rsup|p<rsub|l>>>, 8 being the number of possible symbols), the
  result quality increases. In particular, Figure 3 shows a linear trend for
  the number of optimal solutions found (meaning solutions with fitness = 0).
  It's also noticeable the fact that the <strong|GP> is not capable to find
  any optimal solution with programs shorter than 10. However, for length =
  9, a large number (close to 90%) of the executions finds solutions with
  fitness -1.
  ...
  (e.g. <verbatim|"NOT X1 AND">) operations. This results in a higher number
  of correct possibilities and the trend shown in Fig. 5.
  ...
  analyzed the algorithm performance over 100 executions and with
  ...
  Tables 2 and 3 show the numerical results of the previous tests and the
  best programs created<center|>.
  ...
  <\itemize>
    <item>A length-non-conservative crossover
...
<\references>
  <\collection>
    <associate|auto-1|<tuple|1|1|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-10|<tuple|4|5|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-11|<tuple|5|5|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-12|<tuple|6|6|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-13|<tuple|7|7|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-14|<tuple|8|7|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-15|<tuple|2|8|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-16|<tuple|3|8|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-17|<tuple|6|8|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-18|<tuple|7|8|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-2|<tuple|1|1|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-3|<tuple|2|1|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-4|<tuple|3|2|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-5|<tuple|4|3|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-6|<tuple|5|3|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-7|<tuple|1|3|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-8|<tuple|2|4|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
    <associate|auto-9|<tuple|3|4|../../../../.local/share/pantheon-mail/manda.mgf@gmail.com/attachments/1516/142/report301216_3.tm>>
  </collection>
</references>
...
<\auxiliary>
  <\collection>
    ...
    <\associate|toc>
      ...
      and Boolean Expressions> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
