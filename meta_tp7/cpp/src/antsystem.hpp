...
public:
  GroupKnowledge(meta::ASolution *baseSolution, double t0, double alpha,
                 double beta, double q, double evap);
  ~GroupKnowledge();
...
public:
  AntSystem(meta::ASolution *startSolution, GroupKnowledge *gk, int n_ants = 0,
            int max_t = 50);
  ~AntSystem();
