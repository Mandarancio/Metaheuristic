...
Annealing::Annealing(meta::ASolution *startSolution, int max_perm,
                     int max_accepted)
    : meta::AMeta(startSolution, "Simulated Annealing"), t0_(0), ti_(0),
      max_perm_(max_perm), max_accepted_(max_accepted) {
  if (startSolution_) {
    computeT0();
  }
}
...
void Annealing::step_down_t() { ti_ = 0.9 * ti_; }
...
double Annealing::t0() { return t0_; }
...
void Annealing::set_ti(double t) { ti_ = t; }

double Annealing::ti() { return ti_; }
