...
cd src/
g++ main_matrix.cpp matrix.cpp exmath.cpp -O2 -std=c++11 -o ../bin/test_perf
...
g++ main_img.cpp matrix.cpp img_loader.cpp exmath.cpp -O2 -std=c++11 -o ../bin/img_test -lpython2.7 -g
