...
namespace meta{
  ...
  {
  public:
    RnSolution(math::Vector<double> sol, math::Vector<double> mins, math::Vector<double> maxs, double (*f)(math::Vector<double>));
    RnSolution(int n, math::Vector<double> mins, math::Vector<double> maxs, double (*f)(math::Vector<double>));
    ~RnSolution();
    double max(int d);
    double min(int d);
